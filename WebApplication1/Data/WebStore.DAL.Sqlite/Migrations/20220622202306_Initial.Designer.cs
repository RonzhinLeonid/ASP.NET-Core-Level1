...
namespace WebStore.DAL.Sqlite.Migrations
{
    ...
    [Migration("20220622202306_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Identity.Role", b =>
                {
            ...
            modelBuilder.Entity("DataLayer.Identity.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DataLayer.Order.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DataLayer.Order.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DataLayer.Order.Order", b =>
                {
                    b.HasOne("DataLayer.Identity.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("DataLayer.Order.OrderItem", b =>
                {
                    b.HasOne("DataLayer.Order.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("DataLayer.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DataLayer.Identity.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
